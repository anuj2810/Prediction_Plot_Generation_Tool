...
def generate_maps(tab_files, legend_images, image_names, csv_input, output_dir, band_site_id, site_id):
    for i in range(len(tab_files)):
        ...
        legend_x_offset = base_width + padding + 10
...
if __name__ == "__main__":
    site_id = "RA/UD/TT/13460"  # change as needed
    csv_path = r"C:/Users/anu07/Desktop/pv2/cell_file/final_cell.csv"
    ...
    for band in ["700", "850"]:
        if band in tab_files_by_band and len(tab_files_by_band[band]) >= 4:
            ...
            print(f"⚠️ Skipping {band} MHz: Not enough .tab files (required: 4)")
